...
class ChainsawTransfer extends StatefulWidget {
  final String type;
  const ChainsawTransfer({super.key, required this.type});

  @override
  State<ChainsawTransfer> createState() => _ChainsawTransferState();
}

class _ChainsawTransferState extends State<ChainsawTransfer> {
            ...
            child: Column(
              ...
              children: [
                ...
                _buildFilePicker(
                  ...
                  certChainsawTransfer,
                  (file) => setState(() => certChainsawTransfer = file),
                ),
