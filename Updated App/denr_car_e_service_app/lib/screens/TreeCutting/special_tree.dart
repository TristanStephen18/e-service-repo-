...
class SpecialTree extends StatefulWidget {
  final LatLng geoP;
  ...
  @override
  State<SpecialTree> createState() => _SpecialTreeState();
}

class _SpecialTreeState extends State<SpecialTree> {
