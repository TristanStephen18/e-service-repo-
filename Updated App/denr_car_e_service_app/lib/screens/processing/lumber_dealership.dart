...
class LumberDealership extends StatefulWidget {
  final String type;
  const LumberDealership({super.key, required this.type});

  @override
  State<LumberDealership> createState() => _LumberDealershipState();
}

class _LumberDealershipState extends State<LumberDealership> {
