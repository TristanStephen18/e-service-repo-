...
import 'package:denr_car_e_service_app/screens/TreeCutting/tree_cutting_selection.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  void _handleMapTap(LatLng position) async {
    ...
    isInsideAnyPolygon |= _isPointInsidePolygon(
      position,
      MapConstants.marcosHighway,
    );
    isInsideAnyPolygon |= _isPointInsidePolygon(
      position,
      MapConstants.upperAgno,
    );
    isInsideAnyPolygon |= _isPointInsidePolygon(
      position,
      MapConstants.lowerAgno,
    );
    isInsideAnyPolygon |= _isPointInsidePolygon(
      position,
      MapConstants.mtPulagCoords,
    );
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => TreeCuttingForm(
                            geoP: _selectedLocation!,
                            address: _selectedAddress!,
                            polygonName: polygonName,
                            inside: isInsideAnyPolygon ? "True" : "False",
                          ),
                    ),
                  );
                },
